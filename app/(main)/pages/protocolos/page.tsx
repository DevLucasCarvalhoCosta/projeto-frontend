...
const ProtocolosPage: React.FC = () => {
  ...
  const statusVotacaoOptions = [
    ...
    { label: 'Não Votado', value: 'naoVotado' }
  ];
      ...
      <div className="card">
        ...
        <Dialog visible={showAddModal} style={{ width: '450px' }} header="Adicionar Protocolo" modal className="p-fluid" onHide={handleCloseAddModal}>
          <form onSubmit={handleSaveNewProtocolo}>
            <div className="field">
              ...
              <InputText id="numero" name="numero" value={newProtocolo.numero} onChange={handleChangeNew} required autoFocus />
            </div>
            <div className="field">
        ...
        <Dialog visible={showEditModal} style={{ width: '450px' }} header="Editar Protocolo" modal className="p-fluid" onHide={handleCloseEditModal}>
          <form onSubmit={handleSaveEditProtocolo}>
            <div className="field">
              <label htmlFor="numero">Número</label>
              <InputText id="numero" name="numero" value={editProtocolo?.numero || ''} onChange={handleChangeEdit} required autoFocus />
            </div>
            <div className="field">
              <label htmlFor="assunto">Assunto</label>
            ...
            <div className="field">
              <label htmlFor="conteudo">Conteúdo</label>
              <InputTextarea id="conteudo" name="conteudo" value={editProtocolo?.conteudo || ''} onChange={handleChangeEdit} required rows={3} />
            </div>
            <div className="field">
              <label htmlFor="statusVotacao">Status de Votação</label>
              <Dropdown
                id="statusVotacao"
                name="statusVotacao"
                value={newProtocolo.statusVotacao}
                options={statusVotacaoOptions}
                onChange={handleChangeNew3}
              />
            </div>
            <div className="field">
              <label htmlFor="pdfPath">Caminho do PDF</label>
